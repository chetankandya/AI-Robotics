...
(cl:defmethod cl:initialize-instance :after ((m <ExecuteTst-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExecuteTst-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name air_lab3-srv:<ExecuteTst-request> is deprecated: use air_lab3-srv:ExecuteTst-request instead.")))

(cl:ensure-generic-function 'tst_file-val :lambda-list '(m))
(cl:defmethod tst_file-val ((m <ExecuteTst-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader air_lab3-srv:tst_file-val is deprecated.  Use air_lab3-srv:tst_file instead.")
  (tst_file m))
...
(cl:defmethod cl:initialize-instance :after ((m <ExecuteTst-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ExecuteTst-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name air_lab3-srv:<ExecuteTst-response> is deprecated: use air_lab3-srv:ExecuteTst-response instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <ExecuteTst-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader air_lab3-srv:success-val is deprecated.  Use air_lab3-srv:success instead.")
  (success m))

(cl:ensure-generic-function 'error_message-val :lambda-list '(m))
(cl:defmethod error_message-val ((m <ExecuteTst-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader air_lab3-srv:error_message-val is deprecated.  Use air_lab3-srv:error_message instead.")
  (error_message m))
