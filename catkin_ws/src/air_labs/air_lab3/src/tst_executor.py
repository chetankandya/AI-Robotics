...
class tst_executor:
    def __init__(self):
        ...
        self.service = rospy.Service('execute_tst', air_lab3.srv.ExecuteTst, self.execute_tst)
    ...
    def execute_tst(self, req):
        ...
        if status.type() == TstML.Executor.ExecutionStatus.Type.Finished:
            ...
            return air_lab3.srv.ExecuteTstResponse(True,"No error" )
        else:
            print(status)
            return air_lab3.srv.ExecuteTstResponse(False, "Something went wrong...")
